<template>
  <div id="types-of-cranes">
    ...
    <crane-carousel :style="{ display: !cardClicked ? 'block' : 'none' }" @change-title="changeTitle" />
    <div  :style="{ display: cardClicked ? 'block' : 'none' }" >
      <origin-crane-name v-if="partLearningCraneCard === 0" :craneKind="clickedCrane"></origin-crane-name>
      <crane-operations v-if="partLearningCraneCard === 1" :craneKind="clickedCrane"></crane-operations>
    </div>
