<template>
<svg id="Layer_2-2" data-name="Layer_2-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 4663.59 3531.35">
  <defs>
 
    <linearGradient id="linear-gradient-2-2-2" x1="4105.04" y1="-6954.36" x2="4105.04" y2="-6027.35" gradientTransform="translate(-708.4 4953.35) rotate(-14.14) scale(1 .56)" gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="linear-gradient-2-2" x1="2281.83" y1="715.68" x2="2281.83" y2="934.72" gradientTransform="matrix(1,0,0,1,0,0)" xlink:href="#linear-gradient-2-2-2"/>
    <linearGradient id="linear-gradient-3-2" x1="4584.67" y1="0" x2="4584.67" y2="1005.24" gradientTransform="matrix(1,0,0,1,0,0)" xlink:href="#linear-gradient-2-2-2"/>
    ...
    <linearGradient id="linear-gradient-4-2" x1="3482.78" y1="3058.48" x2="3572.67" y2="3058.48" gradientTransform="matrix(1,0,0,1,0,0)" xlink:href="#linear-gradient-2-2-2"/>
    <linearGradient id="linear-gradient-5-2" x1="3764.09" y1="3058.47" x2="3853.98" y2="3058.47" gradientTransform="matrix(1,0,0,1,0,0)" xlink:href="#linear-gradient-2-2-2"/>
    <linearGradient id="linear-gradient-6-2" x1="3668.38" y1="2936.44" x2="3668.38" y2="3032.14" gradientUnits="userSpaceOnUse">
    ...
    <radialGradient id="radial-gradient-3-2" cx="3467" cy="3125.47" fx="3415.65" fy="3139.63" r="95.96" gradientTransform="translate(372.79) scale(.96 1)" gradientUnits="userSpaceOnUse">
      <stop offset=".03" stop-color="#e6e7e8"/>
      <stop offset="1" stop-color="#808285"/>
    </radialGradient>
    <radialGradient id="radial-gradient-4-2" cx="3446.82" cy="3188.34" fx="3446.82" fy="3188.34" r="114.23" gradientTransform="translate(372.79) scale(.96 1)" gradientUnits="userSpaceOnUse">
      <stop offset=".03" stop-color="#e6e7e8"/>
      <stop offset="1" stop-color="#808285"/>
    </radialGradient>
    <linearGradient id="linear-gradient-7-2" x1="3668.32" y1="3077.79" x2="3668.32" y2="3199.22" gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="linear-gradient-8-2" x1="3838.54" y1="681.45" x2="3838.54" y2="948.99" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#414042"/>
    ...
    <linearGradient id="linear-gradient-9-2" x1="3724.25" x2="3724.25" xlink:href="#linear-gradient-8-2"/>
    <linearGradient id="linear-gradient-10-2" x1="3693.96" y1="815.22" x2="3922.25" y2="815.22" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#58595b"/>
      <stop offset="1" stop-color="#414042"/>
    </linearGradient>
    <linearGradient id="linear-gradient-11-2" x1="3665.93" y1="630.79" x2="3665.93" y2="999.64" gradientUnits="userSpaceOnUse">
  ...
  <g id="_מנוף_תופס" data-name="מנוף תופס">
    ...
    <g>
      <rect class="cls-9-2" x="3764.09" y="2883.72" width="89.89" height="349.49" rx="44.05" ry="44.05"/>
    ...
    <rect class="cls-15-2" x="3572.67" y="2936.44" width="191.43" height="95.7"/>
    <g>
...
.cls-4-2 {
  fill: url(#linear-gradient-10-2);
}

.cls-5-2 {
  fill: url(#linear-gradient-4-2);
}

.cls-6-2 {
  /* fill: url(#radial-gradient-2-2-2); */
  fill: black;
}

.cls-7-2 {
  fill: url(#radial-gradient-3-2);
}

.cls-8-2 {
  fill: url(#linear-gradient-3-2);
}

.cls-9-2 {
  fill: url(#linear-gradient-5-2);
}

.cls-10-2 {
  fill: url(#linear-gradient-8-2);
}

.cls-11-2 {
  fill: url(#radial-gradient-2-2);
}

.cls-12-2 {
  fill: url(#radial-gradient-4-2);
}

.cls-13-2 {
  fill: url(#linear-gradient-7-2);
}

.cls-14-2 {
  fill: url(#linear-gradient-9-2);
}

.cls-15-2 {
  fill: url(#linear-gradient-6-2);
}
...
.cls-16-2 {
  fill: url(#linear-gradient-2-2-2);
}
